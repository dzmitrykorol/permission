...
class BlogPermissionUpdatesPage extends Widget_Base
{
    ...
    {
        return 'blog-permission-updates-page';
    }
    ...
    {
        return __('[D.Korol] Blog Permission Updates Widget', 'elementor-header-bullet');
    }
...
//                            'number' => 3,
                        ...
                        foreach ($pages as $page) {
                            ...
                            <div class="columns-blog">
                                ...
                                <a href="<?php echo get_page_link($id); ?>" class="">
