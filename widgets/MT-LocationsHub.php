 ...
 * @since 1.0.0
 */
class MT_LocationsHub extends Widget_Base {
	...
	public function get_title() {
		return __( '[Master Template] Locations Hub', 'elementor-header-bullet' );
	}
	...
	protected function render() {
		...
		?>
        <section class="location-hub location-hub__locations">
            <div class="container">
                <div class="row">
	                <?php
