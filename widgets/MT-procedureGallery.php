 ...
 * @since 1.0.0
 */
class MT_procedureGallery extends Widget_Base {
	...
	public function get_title() {
		return __( '[Master Template] Procedure Gallery', 'elementor-header-bullet' );
	}
	...
	protected function render() {
        ...
        <section class="sec-gallery">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="owl-carousel procedure-carousel">
	                        <?php
